    ...
    public partial class PlayerStatsForm : Form
    {
        ...
        private void GetSortedListsBySortingCodes(int batting, int pitching, SortingObjects obj)
        {
            ...
            var playerPitchingActions = new List<Func<Player, double>>
            {
                ...
                pitcher => pitcher.PitchingStats.InningsPitched,
                ...
                pitcher => pitcher.PitchingStats.StrikeoutsPerNineInnings,
                pitcher => pitcher.PitchingStats.WalksPerNineInnings,
                pitcher => pitcher.PitchingStats.StrikeoutsPerWalks,
            ...
            if (_objects == SortingObjects.Players)
            {
                ...
                for (var i = 0; i < pitchers.Count; i++)
                {
                    dataGridView3.Rows.Add(i + 1,
                                            ...
                                            pitchers[i].PitchingStats.InningsPitched.ToString("0.0", new CultureInfo("en-US")),
                    ...
                    dataGridView4.Rows.Add(i + 1,
                                            ...
                                            pitchers[i].PitchingStats.StrikeoutsPerNineInnings.ToString("0.00", new CultureInfo("en-US")),
                                            pitchers[i].PitchingStats.WalksPerNineInnings.ToString("0.00", new CultureInfo("en-US")),
                                            pitchers[i].PitchingStats.StrikeoutsPerWalks.ToString("0.00", new CultureInfo("en-US")),
            ...
            else
            {
                ...
                for (var i = 0; i < teamPitching.Count; i++)
                {
                    dataGridView3.Rows.Add(i + 1,
                                            ...
                                            teamPitching[i].PitchingStats.InningsPitched.ToString("0.0", new CultureInfo("en-US")),
                    ...
                    dataGridView4.Rows.Add(i + 1,
                                            ...
                                            teamPitching[i].PitchingStats.StrikeoutsPerNineInnings.ToString("0.00", new CultureInfo("en-US")),
                                            teamPitching[i].PitchingStats.WalksPerNineInnings.ToString("0.00", new CultureInfo("en-US")),
                                            teamPitching[i].PitchingStats.StrikeoutsPerWalks.ToString("0.00", new CultureInfo("en-US")),
