...
namespace VKR_Test
{
    public partial class TeamsSelectForm : Form
    {
        ...
        private void CurrentTeamColorChanged(int teamNumber, int teamColorNumber, Label teamCity, Label teamTitle, Label TeamColorHeader, Button increaseBtn, Button decreaseBtn, Label Balance)
        {
        ...
        private void numericUpDown1_ValueChanged(object sender, EventArgs e)
        {
            ...
            CurrentTeamColorChanged(AwayTeamNumber, CurrentAwayColor, label1, label2, label4, btnIncreaseAwayTeamNumberBy1, btnDecreaseAwayTeamNumberBy1, AwayTeamBalance);
        }
        ...
        private void numericUpDown2_ValueChanged(object sender, EventArgs e)
        {
            ...
            CurrentTeamColorChanged(HomeTeamNumber, CurrentHomeColor, label8, label7, label5, btnIncreaseHomeTeamNumberBy1, btnDecreaseHomeTeamNumberBy1, HomeTeamBalance);
        }
