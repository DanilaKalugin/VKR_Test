...
{
    public class TeamBattingStatsViewMap:IEntityTypeConfiguration<TeamBattingStats>
    {
        public void Configure(EntityTypeBuilder<TeamBattingStats> builder)
        {
            builder.ToView("TeamBattingStatsByYearAndMatchType");
            builder.HasNoKey();
