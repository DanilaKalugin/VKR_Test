...
{
    public class TeamPitchingStatsViewMap:IEntityTypeConfiguration<TeamPitchingStats>
    {
        public void Configure(EntityTypeBuilder<TeamPitchingStats> builder)
        {
            builder.ToView("TeamPitchingStatsByYearAndMatchType");
            builder.HasNoKey();

            builder.Property(vw => vw.TeamName)
            ...
            builder.Property(vw => vw.EarnedRuns)
                .HasColumnName("ER");
        }
    }
}