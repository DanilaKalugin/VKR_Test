...
{
    public partial class UpdateViewInGameBattingStats : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"ALTER VIEW InGameBattingStats AS
...
FROM            dbo.Players CROSS JOIN
                         ...
                         dbo.ExpandedAtBats ON dbo.ExpandedAtBats.Batter = dbo.Players.PlayerID LEFT OUTER JOIN
...
");
        ...
        {
migrationBuilder.Sql(@"ALTER VIEW InGameBattingStats AS
SELECT        dbo.Players.PlayerID, m1.MatchType, m1.Season, COUNT(CASE WHEN AtBatResult = 1 AND m1.Season = YEAR(MatchDate) THEN 1 ELSE NULL END) AS K, COUNT(CASE WHEN AtBatResult = 2 AND 
