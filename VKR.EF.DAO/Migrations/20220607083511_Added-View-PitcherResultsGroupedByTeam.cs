...
{
    public partial class AddedViewPitcherResultsGroupedByTeam : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"CREATE VIEW PitcherResultsGroupedByTeam
AS
...
GROUP BY dbo.PlayersInTeams.TeamID, MatchType, YEAR(MatchDate)");
        ...
        {
            migrationBuilder.Sql("drop view PitcherResultsGroupedByTeam");
        }
    }
}
