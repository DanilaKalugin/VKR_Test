...
namespace VKR.EF.DAO.Migrations
{
    ...
    [Migration("20221215092912_UpdatedKeyInTeamHistoricalName")]
    partial class UpdatedKeyInTeamHistoricalName
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VKR.EF.Entities.ActiveMatchResult", b =>
                {
            ...
            modelBuilder.Entity("VKR.EF.Entities.PlayerPitchingStats", b =>
                {
                    b.Property<int>("CaughtStealing")
                        .HasColumnType("int")
                        .HasColumnName("CS");
            ...
            modelBuilder.Entity("VKR.EF.Entities.StadiumFactor", b =>
                {
                    b.Property<short>("StadiumId")
                        .HasColumnType("smallint")
                        .HasColumnName("Stadium");
            ...
            modelBuilder.Entity("VKR.EF.Entities.TeamBattingStats", b =>
                {
                    b.Property<int>("CaughtStealing")
                        .HasColumnType("int")
                        .HasColumnName("CS");
            ...
            modelBuilder.Entity("VKR.EF.Entities.TeamHistoricalName", b =>
                {
                    b.Property<string>("TeamAbbreviation")
                        .HasColumnType("nvarchar(3)");
            ...
            modelBuilder.Entity("VKR.EF.Entities.TeamPitchingStats", b =>
                {
                    b.Property<int>("CaughtStealing")
                        .HasColumnType("int")
                        .HasColumnName("CS");
            ...
            modelBuilder.Entity("VKR.EF.Entities.MatchResult", b =>
                {
                    b.HasOne("VKR.EF.Entities.Match", "Match")
                        .WithOne("MatchResult")
                        .HasForeignKey("VKR.EF.Entities.MatchResult", "MatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VKR.EF.Entities.Team", "MatchLoser")
                        .WithMany("MatchLosers")
                        .HasForeignKey("MatchLoserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("VKR.EF.Entities.Team", "MatchWinner")
            ...
            modelBuilder.Entity("VKR.EF.Entities.Run", b =>
                {
                    ...
                    b.HasOne("VKR.EF.Entities.PlayerInTeam", "Runner")
                        .WithMany("Runs")
            ...
            modelBuilder.Entity("VKR.EF.Entities.StadiumFactor", b =>
                {
                    b.HasOne("VKR.EF.Entities.Stadium", "Stadium")
                        ...
                        .HasForeignKey("VKR.EF.Entities.StadiumFactor", "StadiumId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
